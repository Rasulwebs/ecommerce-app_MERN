...
// slugify bizga malumot name larini universal yani
// sozlar orasidagi bosh joyga chiziqcha qoyib birlashtirib beradi
...
export const createProductController = async (req, res) => {
  try {
    ...
    switch (true) {
      ...
      case !price:
        return res.status(500).send({ error: "NaPriceme is Required" });
      case !category:
...
export const getSingleProductController = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "Single Products Fitched",
      product,
    });
  } catch (error) {
    console.log(error);
...
export const braintreeTokenController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error in gettong Token Payments Products",
      error,
    });
  }
};
...
export const braintreePaymentController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error in Payments Products",
      error,
    });
  }
};
